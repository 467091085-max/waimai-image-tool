...
STYLE_SLOTS = (
    ...
    BackgroundStyleSlot(
        ...
        "明亮浅石桌面",
        "flat-table",
        "平整浅色石材桌面从左右与下边缘连续铺满，简洁墙面，明亮自然日光",
    ),
    BackgroundStyleSlot(
        "style-4",
        "table-dark-stone",
        "深色石材桌面",
        "flat-table",
        "平整深色哑光石材桌面从左右与下边缘连续铺满，深中性墙面，柔和侧光",
    ),
    BackgroundStyleSlot(
        "style-5",
        "table-natural-wood",
        "温暖木质桌面",
        "flat-table",
        "平整天然木纹桌面从左右与下边缘连续铺满，素净墙面，温暖自然光",
    ),
    BackgroundStyleSlot(
        "style-6",
        ...
        "冷中性商业桌面",
        "flat-table",
        "平整冷中性商业摄影桌面从左右与下边缘连续铺满，无缝简洁背景墙，均匀棚拍光",
    ),
)
