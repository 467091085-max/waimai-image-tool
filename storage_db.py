...
CREATE TABLE IF NOT EXISTS agent_profiles (
    ...
    settlement_account_json TEXT NOT NULL DEFAULT '{}',
...
CREATE INDEX IF NOT EXISTS idx_agent_profiles_user
...
CREATE INDEX IF NOT EXISTS idx_agent_customer_relations_agent_status
    ON agent_customer_relations (agent_id, status);

CREATE INDEX IF NOT EXISTS idx_agent_customer_relations_customer_status
    ON agent_customer_relations (customer_id, status);

CREATE INDEX IF NOT EXISTS idx_agent_customer_relations_created
    ON agent_customer_relations (created_at);
...
CREATE TABLE IF NOT EXISTS commission_orders (
    ...
    status TEXT NOT NULL DEFAULT 'pending'
        CHECK (status IN ('pending', 'eligible', 'settled', 'canceled', 'refunded')),
...
CREATE INDEX IF NOT EXISTS idx_commission_orders_agent_status_created
    ON commission_orders (agent_id, status, created_at);

CREATE INDEX IF NOT EXISTS idx_commission_orders_customer
    ON commission_orders (customer_id);

CREATE INDEX IF NOT EXISTS idx_commission_orders_status_created
    ON commission_orders (status, created_at);

CREATE INDEX IF NOT EXISTS idx_commission_orders_settlement
    ON commission_orders (settlement_id);
...
CREATE TABLE IF NOT EXISTS commission_settlements (
    ...
    total_commission_amount INTEGER NOT NULL DEFAULT 0,
...
CREATE INDEX IF NOT EXISTS idx_commission_settlements_agent_status
    ON commission_settlements (agent_id, status);

CREATE INDEX IF NOT EXISTS idx_commission_settlements_status_created
    ON commission_settlements (status, created_at);

CREATE INDEX IF NOT EXISTS idx_commission_settlements_created
    ON commission_settlements (created_at);
...
CREATE TABLE IF NOT EXISTS agent_withdrawal_requests (
    ...
    balance_snapshot_json TEXT NOT NULL DEFAULT '{}',
...
CREATE INDEX IF NOT EXISTS idx_agent_withdrawal_requests_agent_status
    ON agent_withdrawal_requests (agent_id, status);

CREATE INDEX IF NOT EXISTS idx_agent_withdrawal_requests_status_created
    ON agent_withdrawal_requests (status, created_at);

CREATE INDEX IF NOT EXISTS idx_agent_withdrawal_requests_created
    ON agent_withdrawal_requests (created_at);
...
CREATE TABLE IF NOT EXISTS invite_relations (
    ...
    status TEXT NOT NULL DEFAULT 'pending'
        CHECK (status IN ('pending', 'accepted', 'rewarded', 'canceled', 'expired')),
    reward_points INTEGER NOT NULL DEFAULT 0,
    reward_status TEXT NOT NULL DEFAULT 'pending'
        CHECK (reward_status IN ('pending', 'granted', 'failed', 'canceled')),
    accepted_at TEXT,
    rewarded_at TEXT,
    metadata_json TEXT NOT NULL DEFAULT '{}',
    created_at TEXT NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_invite_relations_inviter
    ON invite_relations (inviter_user_id);

CREATE INDEX IF NOT EXISTS idx_invite_relations_invitee
    ON invite_relations (invitee_user_id);

CREATE INDEX IF NOT EXISTS idx_invite_relations_agent
    ON invite_relations (agent_id);

CREATE INDEX IF NOT EXISTS idx_invite_relations_status_created
    ON invite_relations (status, created_at);

CREATE TABLE IF NOT EXISTS promotion_event_logs (
    id TEXT PRIMARY KEY,
    agent_id TEXT NOT NULL DEFAULT '',
    user_id TEXT NOT NULL DEFAULT '',
    customer_id TEXT NOT NULL DEFAULT '',
...
CREATE INDEX IF NOT EXISTS idx_promotion_event_logs_agent_created
    ON promotion_event_logs (agent_id, created_at);

CREATE INDEX IF NOT EXISTS idx_promotion_event_logs_user_created
    ON promotion_event_logs (user_id, created_at);

CREATE INDEX IF NOT EXISTS idx_promotion_event_logs_event_created
    ON promotion_event_logs (event_type, created_at);

CREATE INDEX IF NOT EXISTS idx_promotion_event_logs_campaign_created
    ON promotion_event_logs (campaign_id, created_at);
...
CREATE INDEX IF NOT EXISTS idx_risk_audit_logs_user_created
    ON risk_audit_logs (user_id, created_at);

CREATE INDEX IF NOT EXISTS idx_risk_audit_logs_agent_created
    ON risk_audit_logs (agent_id, created_at);

CREATE INDEX IF NOT EXISTS idx_risk_audit_logs_asset_created
    ON risk_audit_logs (asset_id, created_at);

CREATE INDEX IF NOT EXISTS idx_risk_audit_logs_event_created
    ON risk_audit_logs (event_type, created_at);

CREATE INDEX IF NOT EXISTS idx_risk_audit_logs_decision_created
    ON risk_audit_logs (decision, created_at);
...
CREATE INDEX IF NOT EXISTS idx_asset_access_logs_asset_created
    ON asset_access_logs (asset_id, created_at);

CREATE INDEX IF NOT EXISTS idx_asset_access_logs_user_created
    ON asset_access_logs (user_id, created_at);

CREATE INDEX IF NOT EXISTS idx_asset_access_logs_agent_created
    ON asset_access_logs (agent_id, created_at);

CREATE INDEX IF NOT EXISTS idx_asset_access_logs_action_created
    ON asset_access_logs (action, created_at);

CREATE INDEX IF NOT EXISTS idx_asset_access_logs_allowed_created
    ON asset_access_logs (allowed, created_at);
"""
